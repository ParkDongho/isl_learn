...
def plot_set_points_3d(set_datas: Union[isl.Set, List[isl.Set]], color="black", size=10, marker="o", scale=1) -> Axes3D:
    ...
    if isinstance(set_datas, (isl.Set, isl.BasicSet, isl.UnionSet)):
        set_datas = [set_datas]
...
def plot_bset_shape_3d(ax: Axes3D, bset_data: isl.BasicSet, show_vertices=False, color="gray",
                       alpha=1.0,
                       vertex_color=None,
...
def plot_set_shapes_3d(set_data: Union[isl.Set, isl.BasicSet], *args, **kwargs) -> Axes3D:
    """
    ...
    """
    ax: Axes3D = _plt.subplot(projection='3d')
    if isinstance(set_data, isl.BasicSet):
...
# def plot_bset_shape_3d(bset_data: isl.BasicSet, show_vertices=False, color="gray",
#                        alpha=1.0,
#                        vertex_color=None,
#                        vertex_marker="o", vertex_size=10,
#                        scale=1, border=0) -> Axes3D:
